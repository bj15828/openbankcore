...
public class DecimalUtil {
  ...
  public static double add(double v1, double v2) { 
      ...
      return b1.add(b2).setScale(DEF_SCALE, BigDecimal.ROUND_HALF_UP).doubleValue(); 
  } 
  
  private static  BigDecimal  setScale(BigDecimal b){
  ...
  public static BigDecimal add(String v1, String v2) { 
      ...
      return b1.add(b2).setScale(DEF_SCALE, BigDecimal.ROUND_HALF_UP); 
  } 
  ...
  public static double sub(double v1, double v2) { 
      BigDecimal b1 = new BigDecimal(Double.toString(v1)); 
      BigDecimal b2 = new BigDecimal(Double.toString(v2)); 
      return b1.subtract(b2).setScale(DEF_SCALE, BigDecimal.ROUND_HALF_UP).doubleValue(); 
  } 
  ...
  public static BigDecimal sub(String v1, String v2) { 
      BigDecimal b1 = new BigDecimal(v1); 
      BigDecimal b2 = new BigDecimal(v2); 
      return b1.subtract(b2).setScale(DEF_SCALE, BigDecimal.ROUND_HALF_UP); 
  } 
  ...
  public static double mul(double v1, double v2) { 
      BigDecimal b1 = new BigDecimal(Double.toString(v1)); 
      BigDecimal b2 = new BigDecimal(Double.toString(v2)); 
      return b1.multiply(b2).setScale(DEF_SCALE, BigDecimal.ROUND_HALF_UP).doubleValue(); 
  } 
  ...
  public static BigDecimal mul(String v1, String v2) { 
      BigDecimal b1 = new BigDecimal(v1); 
      BigDecimal b2 = new BigDecimal(v2); 
      return b1.multiply(b2).setScale(DEF_SCALE, BigDecimal.ROUND_HALF_UP); 
  } 
